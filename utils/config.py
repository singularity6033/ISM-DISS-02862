...
# TEST_IMAGES = os.path.sep.join([ORIG_BASE_PATH, "images/test2017"])
# TEST_ANNOTS = os.path.sep.join([ORIG_BASE_PATH, "annotations/annotations/instances_test2017.json"])
...
MODEL_TRAIN_HIS_PATH = os.path.sep.join([BASE_OUTPUT, "coco_object_detector_rcnn_VGG16_224.pickle"])
